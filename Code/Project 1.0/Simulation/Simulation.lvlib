...
<Library LVVersion="12008004">
	...
	<Item Name="Husky_Host_Sim.lvclass" Type="LVClass" URL="../Husky_Host_Sim.lvclass"/>
	<Item Name="Robot_Host.lvclass" Type="LVClass" URL="../Robot_Host.lvclass"/>
	<Item Name="Sim ID" Type="Variable">
